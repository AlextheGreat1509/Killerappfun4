...
@Path("/api")
    ...
    ListHandler listHandler = new ListHandler();
        ...
        public Response submit(String data) {
            ...
            listHandler.SubmitEntry(submitResponse.getProblemWords(), submitResponse.getTranslationWords(), submitResponse.getTitle(), submitResponse.getProblemLanguage(), submitResponse.getTranslationLanguage(), submitResponse.getPerson());
